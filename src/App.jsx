...
function addToCart(product) {
    // 🚀 تشغيل تأثير المتفرقعات فوراً عند إضافة أي منتج
    confetti({
      particleCount: 80,   // عدد قطع مناسب عشان ميبقاش تقيل مع كل دسة
      spread: 60,          // مدى الانتشار
      origin: { y: 0.8 }   // تطلع من تحت شوية قريبة من مكان الزرار
    });
